...
class ProtectedPagesEditForm extends FormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $pid = NULL) {
        $fields = array('path');
        $conditions = array();
        $conditions['general'][] = array('field' => 'pid', 'value' => $pid, '=', 'operator' => '=');
    ...
    public function validateForm(array &$form, FormStateInterface $form_state) {
        ...
        if (substr($entered_path, 0, 1) != '/') {
            ...
            $normal_path = \Drupal::service('path.alias_manager')->getPathByAlias($form_state->getValue('path'));
            $path_alias = Unicode::strtolower(\Drupal::service('path.alias_manager')->getAliasByPath($form_state->getValue('path')));
            ...
            $conditions['or'][] = array('field' => 'path', 'value' => $path_alias, 'operator' => '=');
            $conditions['and'][] = array('field' => 'pid', 'value' => $form_state->getValue('pid'), 'operator' => '<>');
