...
class ProtectedPagesSendEmailForm extends FormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $pid = NULL) {
        ...
        $form['send_email_box'] = array(
            ...
            '#description' => $this->t('You send details of this protected page by email to multiple users. Please click <a href="@here">here</a> to configure email settings.',
                ['@here' => Url::fromUri('internal:/admin/config/system/protected_pages/settings', array('query' => $this->getDestinationArray()))->toString()]),
            '#open' => TRUE,
        );
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $fields = array('path');
        $conditions = array();
        $conditions['general'][] = array('field' => 'pid', 'value' => $form_state->get('pid'), '=', 'operator' => '=');
