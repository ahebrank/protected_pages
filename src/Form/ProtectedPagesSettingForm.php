...
class ProtectedPagesSettingForm extends ConfigFormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $form['protected_pages_password_fieldset']['protected_pages_user_global_password'] = array(
            ...
            '#default_value' => $config->get('password.per_page_or_global'),//variable_get('protected_pages_user_global_password', 'per_page_or_global'),
            '#options' => array(
      ...
      is 0 (unlimited).'),
            '#default_value' => $config->get('password.protected_pages_session_expire_time'),//variable_get('protected_pages_session_expire_time', 0),
            '#required' => TRUE,
            '#size' => 10,
            '#element_validate' => array(array($this, 'protectedPagesValidateIntegerPositive')),
        ...
        $form['protected_pages_email_fieldset']['protected_pages_email_subject'] = array(
            ...
            '#default_value' => $config->get('email.subject'),//variable_get('protected_pages_email_subject', protected_pages_email_subject()),
        ...
        $form['protected_pages_email_fieldset']['protected_pages_email_body'] = array(
            ...
            '#rows' => 15,
            '#default_value' => $config->get('email.body'),//variable_get('protected_pages_email_body', protected_pages_email_body()),
      ...
      Since password is encrypted, therefore we can not provide it by token.'),
        ...
        $form['protected_pages_other_fieldset']['protected_pages_title'] = array(
            ...
            '#default_value' => $config->get('others.protected_pages_title'),//variable_get('protected_pages_title', t('Protected Page -- Enter password')),
        ...
        $form['protected_pages_other_fieldset']['protected_pages_description'] = array(
            ...
            '#default_value' => $config->get('others.protected_pages_description'),//variable_get('protected_pages_description', t('The page you are trying to view is password protected. Please enter the password below to proceed.')),
        ...
        $form['protected_pages_other_fieldset']['protected_pages_password_label'] = array(
            ...
            '#default_value' => $config->get('others.protected_pages_password_label'),//variable_get('protected_pages_password_label', t('Enter Password')),
        ...
        $form['protected_pages_other_fieldset']['protected_pages_submit_button_text'] = array(
            ...
            '#default_value' => $config->get('others.protected_pages_submit_button_text'),//variable_get('protected_pages_submit_button_text', t('Authenticate')),
        ...
        $form['protected_pages_other_fieldset']['protected_pages_incorrect_password_msg'] = array(
            ...
            '#default_value' => $config->get('others.protected_pages_incorrect_password_msg'),//variable_get('protected_pages_incorrect_password_msg', t('Incorrect password!')),
